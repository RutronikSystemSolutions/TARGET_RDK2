...
#define CY_CFG_SYSCLK_PLL0_FEEDBACK_DIV 50
...
#define CY_CFG_SYSCLK_PLL0_OUTPUT_FREQ 150000000
...
#define CY_CFG_SYSCLK_CLKALTSYSTICK_TICKS ((uint32_t)(((0)/1000000.0)*24000000))
